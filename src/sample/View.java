...
public class View {
    ...
    Button playSampleBtn = new Button("Play");
    Button pauseSampleBtn = new Button("Pause");
    Button startSampleBtn = new Button("Start");
    // Exit
    ...
    private void createAndConfigure(){
        ...
        // Sample
        Header.getChildren().addAll(sampleLbl, sampleLoadbtn, samplePath, playSampleBtn, pauseSampleBtn, startSampleBtn);
